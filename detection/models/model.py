...
from yolo5_utils.downloads import attempt_download
from yolo5_utils.general import check_suffix, intersect_dicts
from yolo5_utils.torch_utils import torch_distributed_zero_first
...
def load_models(weights, nc, device):
    ...
    # supernet
    supernet_path = (os.path.dirname(weights) + '/supernet').replace("\\", '/')

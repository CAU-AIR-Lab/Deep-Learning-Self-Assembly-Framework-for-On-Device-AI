...
class ImageClassifierHelper(
    ...
    private fun setupImageClassifier() {
        ...
        val modelName =
            when (currentModel) {
                MODEL_ORIN -> "model_orin.tflite"
                MODEL_SMALL -> "model_small.tflite"
                MODEL_TINY -> "model_tiny.tflite"
                else -> "model_orin.tflite"
            }
    ...
    companion object {
        ...
        const val MODEL_ORIN = 0
        const val MODEL_SMALL = 1
        const val MODEL_TINY = 2
